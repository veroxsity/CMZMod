...
namespace DNA.Drawing
{
	public class SkySphere : Entity
	{
		...
		{
			CreateBall(game.GraphicsDevice, radius, segments, center, true);
			_effect = new DNAEffect(game.Content.Load<Effect>("SkySphere"));
			_texture = texture;
		...
		public override void Draw(GraphicsDevice device, GameTime gameTime, Matrix view, Matrix projection)
		{
			...
			SetEffectParams(_effect, gameTime, base.LocalToWorld, view, projection);
