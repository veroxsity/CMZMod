...
namespace DNA.Drawing
{
	public class Sprite
	{
		...
		{
			batch.Draw(_texture, destinationRectangle, _sourceRectangle, color);
		}

		public void Draw(SpriteBatch batch, Vector2 position, Color color)
		{
			batch.Draw(_texture, position, _sourceRectangle, color);
		}

		public void Draw(SpriteBatch batch, Vector2 position, float scale, Color color)
		{
			batch.Draw(_texture, new Rectangle((int)position.X, (int)position.Y, (int)((float)_sourceRectangle.Width * scale), (int)((float)_sourceRectangle.Height * scale)), _sourceRectangle, color);
		}

		public void Draw(SpriteBatch batch, Vector2 position, float scale, Color color, SpriteEffects effects)
		{
			batch.Draw(destinationRectangle: new Rectangle((int)position.X, (int)position.Y, (int)((float)_sourceRectangle.Width * scale), (int)((float)_sourceRectangle.Height * scale)), texture: _texture, sourceRectangle: _sourceRectangle, color: color, rotation: 0f, origin: Vector2.Zero, effects: effects, layerDepth: 1f);
		}

		public void Draw(SpriteBatch batch, Rectangle destinationRectangle, Rectangle sourceRectangle, Color color)
		{
			batch.Draw(sourceRectangle: new Rectangle(sourceRectangle.Left + _sourceRectangle.Left, sourceRectangle.Top + _sourceRectangle.Top, sourceRectangle.Width, sourceRectangle.Height), texture: _texture, destinationRectangle: destinationRectangle, color: color);
		}
		...
		{
			batch.Draw(sourceRectangle: new Rectangle(sourceRectangle.Left + _sourceRectangle.Left, sourceRectangle.Top + _sourceRectangle.Top, sourceRectangle.Width, sourceRectangle.Height), texture: _texture, destinationRectangle: destinationRectangle, color: color, rotation: rotation.Radians, origin: origin, effects: effects, layerDepth: layerDepth);
		}
		...
		{
			batch.Draw(_texture, position, _sourceRectangle, color, rotation.Radians, origin, scale, effects, layerDepth);
		}
		...
		{
			batch.Draw(sourceRectangle: new Rectangle(sourceRectangle.Left + _sourceRectangle.Left, sourceRectangle.Top + _sourceRectangle.Top, sourceRectangle.Width, sourceRectangle.Height), texture: _texture, position: position, color: color, rotation: rotation.Radians, origin: origin, scale: scale, effects: effects, layerDepth: layerDepth);
		}
