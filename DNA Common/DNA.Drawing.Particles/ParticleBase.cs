...
namespace DNA.Drawing.Particles
{
	public class ParticleBase<T>
	{
		...
		public Vector2 TileSize
		{
			get
			{
				return new Vector2(1f / (float)_numTilesWide, 1f / (float)_numTilesHigh);
			}
		}
		...
		public int FirstTileToInclude
		{
			get
			{
				return _firstTileToInclude;
			}
			set
			{
				_firstTileToInclude = value;
			}
		}
		...
		public int LastTileToInclude
		{
			get
			{
				return _lastTileToInclude;
			}
			set
			{
				_lastTileToInclude = value;
			}
		}
		...
		public float DistortionAmplitude
		{
			get
			{
				return _distortionAmplitude;
			}
			set
			{
				_distortionAmplitude = value;
			}
		}
