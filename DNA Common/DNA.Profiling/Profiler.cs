	...
	public class Profiler : DrawableGameComponent
	{
		...
		public static Profiler CreateComponent(Game game)
		{
			if (_theInstance == null)
			{
				...
				game.Components.Add(_theInstance);
			}
			return _theInstance;
		}
		...
		private bool GetSectionColors()
		{
			...
			{
				_sectionNames = _colorDict.Keys.ToArray();
				_sectionColors = _colorDict.Values.ToArray();
		...
		public override void Draw(GameTime gameTime)
		{
			if (_profiling && _eventsToBeReported != null)
			{
				...
				_sampleWaitTime -= (float)gameTime.ElapsedGameTime.TotalSeconds;
