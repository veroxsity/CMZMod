...
namespace DNA.Drawing.Curves.Splines
{
	public class HermiteSpline : Spline
	{
		...
		private static Vector3 ComputeValue(float t, ControlPoint cp1, ControlPoint cp2)
		{
			...
			float num6 = num2 - num;
			float x = num3 * location.X + num4 * location2.X + num5 * vector.X + num6 * vector2.X;
			float y = num3 * location.Y + num4 * location2.Y + num5 * vector.Y + num6 * vector2.Y;
			float z = num3 * location.Z + num4 * location2.Z + num5 * vector.Z + num6 * vector2.Z;
