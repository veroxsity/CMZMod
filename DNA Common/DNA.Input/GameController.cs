...
namespace DNA.Input
{
	public class GameController
	{
		...
		public bool Activity
		{
			get
			{
				if (!ButtonPressed && !(_currentState.ThumbSticks.Left.LengthSquared() > LeftStickThreshold * LeftStickThreshold) && !(_currentState.ThumbSticks.Right.LengthSquared() > RightStickThreshold * RightStickThreshold))
				{
					return _currentState.DPad != _unpressedDPad;
				}
				return true;
			}
		}
