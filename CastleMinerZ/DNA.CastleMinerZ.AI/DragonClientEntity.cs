...
namespace DNA.CastleMinerZ.AI
{
	public class DragonClientEntity : Entity, IShootableEnemy
	{
		...
		public static void Init()
		{
			...
			DeathAnimationPackages[0].PauseTime = 1.3666667f;
		...
		public void AddActionWaypoint(ActionDragonWaypoint inwpt)
		{
			...
			{
				Waypoints.Clear();
				ActionDragonWaypoint item = new ActionDragonWaypoint
				{
					Action = DragonWaypointActionEnum.GOTO,
					BaseWpt = 
					{
						Position = base.WorldPosition,
						Velocity = CurrentVelocity,
						HostTime = CurrentInterpolationTime,
						Animation = CurrentAnimation,
						Sound = DragonSoundEnum.NONE
					},
					FireballIndex = 0
				};
				Waypoints.Add(item);
		...
		public override void Update(DNAGame game, GameTime gameTime)
		{
			...
			if (FlapTimer.Expired && CurrentAnimation != DragonAnimEnum.SOAR)
			{
