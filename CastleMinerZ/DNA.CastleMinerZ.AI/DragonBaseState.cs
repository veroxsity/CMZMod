...
namespace DNA.CastleMinerZ.AI
{
	public class DragonBaseState : IFSMState<DragonEntity>
	{
		...
		{
			BaseDragonWaypoint result = new BaseDragonWaypoint
			{
				Position = entity.LocalPosition,
				Velocity = entity.LocalToWorld.Forward * entity.Velocity,
				HostTime = entity.DragonTime,
				Animation = nextanim,
				TargetRoll = entity.TargetRoll,
				Sound = entity.NextSound
			};
