...
namespace DNA.CastleMinerZ.AI
{
	public abstract class EnemyType
	{
		...
		public static readonly string[] _modelNames = new string[7] { "Enemies\\Zombies\\zombieHigh", "Enemies\\Skeletons\\SkeletonZombie", "Enemies\\Skeletons\\SkeletonArcher", "Enemies\\Skeletons\\SkeletonAxes", "Enemies\\Skeletons\\SkeletonSword", "Enemies\\Demon\\Demon", "Enemies\\Alien\\alien" };

		public static readonly float[] _modelScales = new float[7] { 1f, 1f, 1f, 1f, 1f, 1f, 1f };

		public static readonly float[] _modelFacing = new float[7] { 3.141592f, 3.141592f, 3.141592f, 3.141592f, 3.141592f, 3.141592f, 3.141592f };

		public static readonly string[] _textureNames = new string[14]
		{
			...
			"Enemies\\Skeletons\\skele-06", "Enemies\\Skeletons\\skele-07", "Enemies\\Demon\\demon_0", "Enemies\\Alien\\warrior_0"
		};
		...
		public static void Init()
		{
			...
			Types[50].StartingHealth = 140f;
			Types[51].StartingHealth = 70f;
		}
		...
		public static EnemyTypeEnum GetZombie(float distance)
		{
			...
			return FindEnemy(188.88889f, distance, EnemyTypeEnum.ZOMBIE_0_0, EnemyTypeEnum.ZOMBIE_2_4);
		}
		...
		{
			InitPackage result = new InitPackage
			{
				SlowSpeed = MathTools.RandomFloat(BaseSlowSpeed, BaseSlowSpeed + RandomSlowSpeed)
			};
			if (HasRunFast)
			{
