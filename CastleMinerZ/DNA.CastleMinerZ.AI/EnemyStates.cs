namespace DNA.CastleMinerZ.AI
{
	public class EnemyStates
	{
		...
		public static IFSMState<BaseZombie> ZombieDig = new ZombieDig();
		...
		public static IFSMState<BaseZombie> AlienEmerge = new AlienEmerge();

		public static IFSMState<BaseZombie> AlienAttack = new AlienAttack();

		public static IFSMState<BaseZombie> AlienGiveUp = new AlienGiveUp();

		public static IFSMState<BaseZombie> AlienHit = new AlienHit();

		public static IFSMState<BaseZombie> AlienDie = new AlienDie();

		public static IFSMState<BaseZombie> AlienChase = new AlienChase();
