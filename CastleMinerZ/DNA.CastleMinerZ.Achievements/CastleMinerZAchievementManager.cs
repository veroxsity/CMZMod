namespace DNA.CastleMinerZ.Achievements
{
	public class CastleMinerZAchievementManager : AchievementManager<CastleMinerZPlayerStats>
	{
		...
		public override void CreateAcheivements()
		{
			...
			AddAcheivement(Achievements[25] = new AlienEncounterAchievement(this, "Alien Encounter"));
			AddAcheivement(Achievements[26] = new EnemiesKilledWithLaserWeaponAchievement(this, "Alien Technology"));
			AddAcheivement(Achievements[27] = new CraftTNTAcheivement(this, "Demolition Expert"));
			AddAcheivement(Achievements[28] = new KillDragonGuidedMissileAchievement(this, "Air Defense"));
			AddAcheivement(Achievements[29] = new KillEnemyTNTAchievement(this, "Fire In The Hole"));
			AddAcheivement(Achievements[30] = new KillEnemyGrenadeAchievement(this, "Boom"));
		}
