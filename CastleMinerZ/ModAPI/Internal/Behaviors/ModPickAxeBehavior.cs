...
{
    public class ModPickAxeBehavior : ModelInventoryItemClass
    {
        public ModPickAxeBehavior(ItemDef def)
                   ...
                   def.MaxStackSize, def.CoolDownTime, Color.White)
        {
            ...
            _model = CastleMinerZGame.Instance.Content.Load<Model>("PickAxe");
