...
namespace DNA.CastleMinerZ.Inventory
{
	public class KnifeInventoryItemClass : ModelInventoryItemClass
	{
		...
		public KnifeInventoryItemClass(InventoryItemIDs id, Model model, ToolMaterialTypes material, string name, string description1, string description2, float meleeDamage, float itemselfDamage, TimeSpan coolDown)
			: base(id, model, name, description1, description2, 1, coolDown, Color.White)
		{
