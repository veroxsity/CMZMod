...
namespace DNA.CastleMinerZ.Inventory
{
	public class SpadeInventoryClass : ModelInventoryItemClass
	{
		...
		public SpadeInventoryClass(InventoryItemIDs id, ToolMaterialTypes material, Model model, string name, string description1, string description2, float meleeDamage)
		...
		public override Entity CreateEntity(ItemUse use, bool attachedToLocalPlayer)
		{
			...
			case ItemUse.UI:
			{
				...
				Vector3 translation = new Vector3(-10f, -10f, 0f);
